...
Note that included with this lesson plan is the `TLM_Roadtrip` directory. This is a supplemental activity you can do to practice your bash navigation skills. Checkout the project's `README.md` file for instructions. If you have any questions about this exercise, please bring them up to your instructor or send a ticket to Help Desk.
...
1. What are the three main front-end technologies you've learned so far?
2. Name at least one third-party library you used in WDF.
3. What are some of the conditional statments used in JavaScript?
4. Name at least one kind of loop used in JavaScript?
5. In what ways can you declare a variable in JavaScript?

---

## What is a Shell? ##

A Shell provides you with an interface to the [Unix](https://wikipedia.tlm.cloud/wikipedia_en_computer_2017-04/A/Unix.html) system running on your Mac. It gathers input from you and executes programs based on that input. When a program finishes executing, it displays that program's output.
...
This will take you to your `Documents` directory that we copied in earlier. Note that the `~` symbol designates your home directory. Next use the `ls` command to list the contents of this directory:

```bash
  ls
```

Within the output you should see the `movie-buzz` directory. Now move into this directory and list its contents:
